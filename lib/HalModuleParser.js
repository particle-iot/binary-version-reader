...
HalModuleParser.prototype = {
	...
	_readPrefix: function(fileBuffer) {
		...
		// TODO: so a quick test is to read byte at index 3 and see if it’s 2 or 8 and, if it’s 2 then read module info from 388, otherwise read from 0.

		r.skip(388);

		//just system modules have the offset at the beginning. They always start 0x2xxxxxxx
		//while a user module starts 0x8xxxxxxx
