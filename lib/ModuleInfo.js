 ...
 *
 * NOTE: some platforms now have dynamic extensions in the module suffix, 128 is sufficiently big enough
 * to fit them for now, however we should not rely on this number going forward.
 */
const MAX_MODULE_SUFFIX_SIZE = 128;
