 ...
 *
 * This is the size of the `module_info_suffix_t` structure in Device OS, plus 4 bytes reserved
 * for the 16-bit product ID and product version fields.
 */
const MINIMUM_MODULE_SUFFIX_SIZE = 40;
