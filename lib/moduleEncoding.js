 ...
 *
 * @param {Object} vars Snapshot object.
 ...
 * @param {Buffer} [opts.override=false] If `true`, the asset is marked as containing overridden variables.
 * @returns {Promise<Buffer>} Module binary.
 */
async function createEnvVarsAssetModule(vars, { override } = {}) {
