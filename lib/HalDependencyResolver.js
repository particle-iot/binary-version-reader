...
/**
 * fancy module that can assimilate system modules and their version info.  It uses that combined with the
 * describe payload from your device, and the version info from a new binary to recursively resolve
...
HalDependencyResolver.prototype = {
	...
	parse_and_resolve: function(describe, fileBuffer) {
		if (describe && !util.isArray(describe) && describe.m) {
			//those goofs, they sent the whole thing, instead of just the modules section.
			describe = describe.m;
		}
