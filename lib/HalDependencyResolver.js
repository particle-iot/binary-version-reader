...
//	/*
//	 * TODO: this is redundant, right?  since we have walkChain?
//	 * TODO: fix misspelling of "Dependecy"
//	 *
//	 * Given modules tries to recursively find first
//	 * dependency to be flashed.
//	 *
//	 * Resolves FirmwareModule if success
//	 * Rejects null if no currentModule was passed
//	 * Rejects Array containing missing dependencies if they are not met
//	 *
//	 * @param Object describe - describe message
//	 * @param Promise
//	 */
//	_getModuleFirstDependecy: function(modules, currentModule) {
//		if (!currentModule) {
//			return when.reject();
//		}
//		// Check if it also has dependencies
//		if (currentModule.dependencies.length === 0) {
//			//NOTE: this incorrectly returns things with no dependencies
//			// that are also not required, like the bootloader.
//
//			return when.resolve(currentModule);
//		} else {
...
//					break;
//				}
//				var missing = currentModule.dependencies[i];
//				for (var j = 0; j < modules.length; j++) {
//					var module = modules[j];
//					if (module.version >= missing.version &&
//							module.func === missing.func &&
//							module.name === missing.name) {
//
...
//				// that are also not required, like the bootloader.
//
//				return when.reject(currentModule.dependencies);
//			}
//
//			return this._getModuleFirstDependecy(modules, missingModule);
//		}
//	},
